...
/* ✅ FIXED: loosen type to avoid TS error */
/*
...
function Editor() {
    ...
    useEffect(() => {
        ...
        const langExt = langId ? loadLanguage(langId as any) : null
...
function Editor() {
    ...
    useEffect(() => {
        ...
        // } else {
        //     toast.error(
        //         "Syntax highlighting unavailable for this language.",
        //         { duration: 5000 },
        //     )
        // }
    ...
    /*
    // 🔥 COPILOT OUTPUT INJECTION (MAIN MAGIC)
    useEffect(() => {
        if (!output || !editorRef.current?.view || !activeFile) return
